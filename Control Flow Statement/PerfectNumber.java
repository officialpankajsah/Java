//Q-> A perfect number is a positive integer which is equal to the sum of its proper positive divisors.
...
public class PerfectNumber {
    public static void main(String[] args) {
        ...
        System.out.println("Is it perfect number is : " + isPerfectNumber(number));
