//Q-> Bob is a wall painter, and he needs your help. You have to write a program that helps Bob calculate how many
...
//    getBucketCount(3.4, 2.1, 1.5, 2); → should return 3 since the wall area is 7.14, a single bucket can cover an
//    area of 1.5 and Bob has 2 extra buckets home.
//    getBucketCount(2.75, 3.25, 2.5, 1); → should return 3 since the wall area is 8.9375, a single bucket can cover
...
//    Write another overloaded method named getBucketCount with 2 parameters namely, area and areaPerBucket (both of
//    type double).
...
//    getBucketCount(6.26, 2.2); → should return 3 since the wall area is 6.26 and a single bucket can cover an area
//    of 2.2.
